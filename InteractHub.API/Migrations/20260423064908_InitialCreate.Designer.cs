...
namespace InteractHub.API.Migrations
{
    ...
    [Migration("20260423064908_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InteractHub.API.Models.Friendship", b =>
                {
                    b.HasOne("InteractHub.API.Models.ApplicationUser", "Receiver")
                        .WithMany("ReceivedFriendRequests")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("InteractHub.API.Models.ApplicationUser", "Requester")
            ...
            modelBuilder.Entity("InteractHub.API.Models.Notification", b =>
                {
                    b.HasOne("InteractHub.API.Models.ApplicationUser", "TriggeredByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("InteractHub.API.Models.Post", b =>
                {
                    b.HasOne("InteractHub.API.Models.Post", "OriginalPost")
                        .WithMany("Shares")
